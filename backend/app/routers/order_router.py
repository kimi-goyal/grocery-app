...
def place_order(
    ...
    for ci in cart_items:
        ...
        # Decrement product stock and increase selling count
        ...
        if prod:
            ...
            if prod.stock < ci.qty:
                raise HTTPException(400, f"Insufficient stock for product {prod.name}")
            prod.stock = prod.stock - ci.qty
            # update selling_count for analytics
            if hasattr(prod, 'selling_count'):
                prod.selling_count = (prod.selling_count or 0) + ci.qty
